...
// Updated for Project 2. Added kernel call declarations for Mailbox.
...
// Updated for Project 3. Added kernel call declarations for Mailbox security.
int do_add_owner(struct proc *caller, message *m_ptr);
int do_remove_owner(struct proc *caller, message *m_ptr);
int do_add_mailbox_sender(struct proc *caller, message *m_ptr);
int do_remove_mailbox_sender(struct proc *caller, message *m_ptr);
int do_add_mailbox_receiver(struct proc *caller, message *m_ptr);
int do_remove_mailbox_receiver(struct proc *caller, message *m_ptr);
