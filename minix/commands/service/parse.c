...
} system_tab[]=
{
	...
	{ "MEMSET",		SYS_MEMSET },
	{ "PADCONF",		SYS_PADCONF },
	// Updated for Project 2. Mailbox call names.
	{ "CREATE_MAILBOX",	SYS_CREATE_MAILBOX },
	{ "REMOVE_MAILBOX",	SYS_REMOVE_MAILBOX },
	{ "DEPOSIT_MAIL",	SYS_DEPOSIT_MAIL },
	{ "RETRIEVE_MAIL",	SYS_RETRIEVE_MAIL },
	// Updated for Project 3. Mailbox security call names.
	{ "ADD_OWNER",	SYS_ADD_OWNER },
	{ "REMOVE_OWNER",	SYS_REMOVE_OWNER },
	{ "ADD_MAILBOX_SENDER",	SYS_ADD_MAILBOX_SENDER },
	{ "REMOVE_MAILBOX_SENDER",	SYS_REMOVE_MAILBOX_SENDER },
	{ "ADD_MAILBOX_RECEIVER",	SYS_ADD_MAILBOX_RECEIVER },
	{ "REMOVE_MAILBOX_RECEIVER",	SYS_REMOVE_MAILBOX_RECEIVER },
	{ NULL,		0 }
};
