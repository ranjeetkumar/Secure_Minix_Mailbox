...
// Updated for Project 2. Added Mailbox call numbers.

#  define SYS_CREATE_MAILBOX (KERNEL_CALL + 58)		/* sys_create_mailbox() */
#  define SYS_REMOVE_MAILBOX (KERNEL_CALL + 59)		/* sys_remove_mailbox() */
#  define SYS_DEPOSIT_MAIL (KERNEL_CALL + 60)		/* sys_deposit_mail() */
#  define SYS_RETRIEVE_MAIL (KERNEL_CALL + 61)		/* sys_remove_mail() */

// Updated for Project 3. Added Mailbox security call numbers.

#  define SYS_ADD_OWNER (KERNEL_CALL + 62)					/* sys_add_owner() */
#  define SYS_REMOVE_OWNER (KERNEL_CALL + 63)				/* sys_remove_owner() */
#  define SYS_ADD_MAILBOX_SENDER (KERNEL_CALL + 64)			/* sys_add_mailbox_sender() */
#  define SYS_REMOVE_MAILBOX_SENDER (KERNEL_CALL + 65)		/* sys_remove_mailbox_sender() */
#  define SYS_ADD_MAILBOX_RECEIVER (KERNEL_CALL + 66)		/* sys_add_mailbox_receiver() */
#  define SYS_REMOVE_MAILBOX_RECEIVER (KERNEL_CALL + 67)	/* sys_remove_mailbox_receiver() */

/* Total */
#define NR_SYS_CALLS	68	/* number of kernel calls */
